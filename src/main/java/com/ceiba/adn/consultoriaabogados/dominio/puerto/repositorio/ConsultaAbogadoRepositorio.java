...
public interface ConsultaAbogadoRepositorio {
	...
	/**
	 * Metodo que lista todas las consultas que fueron creadas
	 * 
	 * @return consultas
	 */
	...
	/**
	 * Metodo que verifica si el cliente ya tiene una cita para ese dia
	 * 
	...
	/**
	 * Metodo que registra una nueva consulta
	 * 
